...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 11 sep. 2020 à 09:58
...
--
-- Base de données : `autentification`
--
...
--
ALTER TABLE `reset_token`
  ADD CONSTRAINT `reset_token_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
